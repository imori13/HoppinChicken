...
namespace FliedChicken.GameObjects.Objects
{
    static class EnemyFactory
    {
        private static Dictionary<string, Enemy> enemyDictionary = new Dictionary<string, Enemy>()
        {
            ...
            { "highspeed_enemy", new Enemy( 64 * 10, 64 * 8, 64 * 10, 64 * 8) { MinSpeed = 1, MaxSpeed = 3, MinInterval = 12, MaxInterval = 15 } },
            { "slowenemy", new Enemy(64 * 6, 64 * 4,  64 * 6, 64 * 4) { MinSpeed = 16, MaxSpeed = 18, MinInterval = 7, MaxInterval = 10} }
        };
