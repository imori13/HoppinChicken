...
namespace FliedChicken.GameObjects.Objects
{
    static class EnemyFactory
    {
        ...
        {
            { "Kamome", new Enemy("Pixel", 64 * 3, 64 * 3) { MinSpeed = 4, MaxSpeed = 8, MinInterval = 2, MaxInterval = 4 } },
            { "Zeppelin", new Enemy("Pixel", 64 * 10, 64 * 8) { MinSpeed = 1, MaxSpeed = 3, MinInterval = 12, MaxInterval = 15 } },
            { "Airplane", new Enemy("Pixel", 64 * 6, 64 * 4) { MinSpeed = 16, MaxSpeed = 18, MinInterval = 7, MaxInterval = 10} }
        };
