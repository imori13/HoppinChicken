...
namespace FliedChicken.GameObjects.Objects
{
    static class EnemyFactory
    {
        ...
        {
            { "normal_enemy", new Enemy( 64 * 3, 64 * 3, 64 * 3, 64 * 3) { MinSpeed = 4, MaxSpeed = 8, MinInterval = 2, MaxInterval = 4 } },
            { "slowenemy", new Enemy( 64 * 10, 64 * 8, 64 * 10, 64 * 8) { MinSpeed = 1, MaxSpeed = 3, MinInterval = 12, MaxInterval = 15 } },
            { "highspeed_enemy", new Enemy(64 * 6, 64 * 4,  64 * 6, 64 * 4) { MinSpeed = 16, MaxSpeed = 18, MinInterval = 7, MaxInterval = 10} }
        };

        public static void Initialize()
        {
            enemyDictionary["normal_enemy"].Animation = new Animation("normal_enemy", new Vector2(320, 320), 5, 0.25f);
